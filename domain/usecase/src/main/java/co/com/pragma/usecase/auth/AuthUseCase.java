...
public class AuthUseCase implements IAuthUseCase{
     ...
     */
    private <T> Mono<T> validate(T object, Function<T, Map<String, String>> validationFunction) {
        return Mono.defer(() -> {
     ...
     */
    private void validateNotBlank(String value, String fieldName, String errorMessage, Map<String, String> errors) {
     ...
     */
    private void validateEmail(String email, String fieldName, Map<String, String> errors) {
